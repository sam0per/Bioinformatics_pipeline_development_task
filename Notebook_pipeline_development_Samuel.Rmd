...
```{bash interval_chr19, eval=FALSE, include=TRUE}
...
fig
```
Figure 1. Read coverage for the overall region of chromosome 19, for the target and off-target region. Top panel: Values of the three means of coverage and fraction of bases of the found read coverages, but not for all the depths. Bottom panel (interactive): Fraction of the chr19 region or breadth of coverage that was covered with a ceratin number of reads.
